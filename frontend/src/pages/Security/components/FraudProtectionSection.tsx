...
export const FraudProtectionSection = () => (
  <Section className="bg-brand-surface">
    ...
    >
      <div>
        <h2 className="text-brand-fg text-4xl font-bold mb-10">
          Real-time Fraud Protection
        </h2>
        <div className="flex flex-col gap-8 text-brand-fg-muted">
          <p>
            NovaBank monitors every transaction 24/7 using machine learning
            models trained on billions of data points. Suspicious activity
            triggers instant alerts and automatic account safeguards before
            damage can occur.
          </p>
          <p>
            Our dedicated fraud team works around the clock to investigate
            anomalies. If you ever spot something wrong, freeze your account
            instantly in-app and our team will be on the case within minutes.
          </p>
      ...
      <div className="flex flex-col gap-5 bg-brand-accent/10 p-10 rounded-3xl">
        ...
        <h2 className="font-bold text-brand-fg text-xl">
          Zero-liability guarantee
        </h2>
        <p className="text-brand-fg-muted">
          If an unauthorized transaction ever appears on your account, we will
          refund it - no questions asked. You are never responsible for
          fraudulent charges made without your authorization.
        </p>
